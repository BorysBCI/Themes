	...
	simplecontactForm: function(){	
		...
		$('#contactform').bootstrapValidator({
			...
			// .on('success.form.bv', function(e) {
				...
				// 		type: "POST",
				// 		dataType: 'json',
				// 		url: "/wp-content/themes/roofing/page-contact.php",					
				// 		data: form_data,
...
function GmapInit() {
  var myLatLng = {lat: 51.6463181, lng: 5.2929132};

  // Create a map object and specify the DOM element for display.
  var map = new google.maps.Map(document.getElementById('map_my'), {
    center: myLatLng,
    scrollwheel: false,
    zoom: 17
  });
  ...
  var marker = new google.maps.Marker({
    map: map,
    position: myLatLng,
    title: 'Industrieweg 5f, 5262 GJ Vught, Nederland'
  });
}
