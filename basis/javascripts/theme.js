...
jQuery("#reg-form").submit(function validate(){
	var form = document.forms[0];

		if( (form.elements.fname.value == "") || (form.elements.lname.value == "") || (form.elements.email.value == "")	|| (form.elements.username.value == "") || (form.elements.password.value == "")	|| (form.elements.confirm_password.value == "")	|| (form.elements.organization.value == "")	|| (form.elements.city.value == "")	|| (form.elements.state.value == "")){
				//alert("Please check and fill required field in the form!");
				//return false;
		} else {
			alert("Thank you for registering with the TandemNSI team for access to the TandemNSI Cybersecurity Industry List");
				window.location.href = 'http://www.tandemnsi.com/research/tandemnsi-cybersecurity-industry-list/';
				//return true;
		}
    });
